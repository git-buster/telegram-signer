...
import telegram_signer.cli.signer as signer_cli
...
def test_migrate_sign_records_command(tmp_path):
    ...
    assert "Migrated files: 1" in result.output
    assert "Migrated records: 1" in result.output
